  ...
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mt-4">
        All{" "}
        <code className="bg-muted px-1.5 py-0.5 rounded text-sm">/api/*</code>{" "}
        endpoints require authentication via Bearer token. Narrative Protocol
        supports two authentication methods:
      </p>

      <Callout type="info" title="Development Mode">
        <p className="text-muted-foreground">
          For now, use <strong>Debug Authentication</strong> for development and
          testing. Privy authentication will be available for production use.
        </p>
      </Callout>

      <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
        <li>
          <strong>Privy Authentication</strong> - Production auth via Privy
        </li>
        <li>
          <strong>Debug Authentication</strong> - Simple JWT for
          development/testing
        </li>
      </ol>
      ...
      <p className="text-muted-foreground">
        For development and testing, use the debug authentication system. This
        creates a user and returns a JWT token signed by the server.
      </p>
      ...
      <CodeBlock code={`POST /DEBUG_register`} language="http" />
    ...
    "description": "A test world"
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        <li>
          See{" "}
          <Link
            href="/docs/api-reference/worlds"
            className="text-primary hover:underline"
          >
            Worlds API
          </Link>{" "}
          to create your first world
        </li>
        <li>
          Check{" "}
          <Link
