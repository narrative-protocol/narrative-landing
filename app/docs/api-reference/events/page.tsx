...
export default function EventsAPIPage() {
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mt-4">
        Events define what can happen in your world. Each event can have
        multiple versions.
      </p>
      ...
      <CodeBlock code={`GET /api/worlds/:worldId/events`} language="http" />

      <p className="text-muted-foreground">
        <strong>Direct route</strong>
      </p>

      <CodeBlock code={`GET /api/events?worldId=<world-id>`} language="http" />

      <h3 className="text-xl font-semibold text-foreground mt-6">
        Create Event
      </h3>
      <p className="text-muted-foreground">
        Creates an event with its first version. Every event must have at least
        one version.
      </p>
      <p className="text-muted-foreground">
        <strong>Nested route (recommended)</strong>
      ...
      <CodeBlock code={`POST /api/worlds/:worldId/events`} language="http" />
      ...
      <table className="w-full border-collapse border border-border my-4">
        ...
        <tbody>
          ...
          <tr className="border-b border-border">
            ...
            <td className="px-4 py-2 text-muted-foreground">Yes</td>
            <td className="px-4 py-2 text-muted-foreground">
              First version configuration
            </td>
          </tr>
          <tr className="border-b border-border">
            <td className="px-4 py-2 text-muted-foreground">
              <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
                firstVersion.inputSchema
              </code>
            </td>
            <td className="px-4 py-2 text-muted-foreground">object</td>
            <td className="px-4 py-2 text-muted-foreground">No</td>
          ...
          <tr className="border-b border-border">
            ...
            <td className="px-4 py-2 text-muted-foreground">No</td>
            <td className="px-4 py-2 text-muted-foreground">
              Entity schema IDs to read
            </td>
          </tr>
          <tr className="border-b border-border">
            <td className="px-4 py-2 text-muted-foreground">
              <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
                firstVersion.stateChangeSchema
              </code>
            </td>
            <td className="px-4 py-2 text-muted-foreground">object</td>
            <td className="px-4 py-2 text-muted-foreground">No</td>
  ...
  "data": {
    ...
    "versions": [
      ...
      <CodeBlock code={`GET /api/events/:id`} language="http" />

      <p className="text-muted-foreground">Returns event with all versions.</p>

      <h3 className="text-xl font-semibold text-foreground mt-6">
        Update Event
      </h3>

      <CodeBlock code={`PUT /api/events/:id`} language="http" />

      <h3 className="text-xl font-semibold text-foreground mt-6">
        Delete Event
      </h3>

      <CodeBlock code={`DELETE /api/events/:id`} language="http" />
