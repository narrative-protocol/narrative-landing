...
export default function WorldsAPIPage() {
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <p className="text-lg text-muted-foreground mt-4">
        Worlds are the top-level containers for all definitions in Narrative
        Protocol.
      </p>
      ...
      <CodeBlock code={`GET /api/worlds`} language="http" />
  ...
  "data": [
    {
      ...
      <CodeBlock code={`POST /api/worlds`} language="http" />
      ...
      <table className="w-full border-collapse border border-border my-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="px-4 py-2 text-muted-foreground">No</td>
            <td className="px-4 py-2 text-muted-foreground">
              Base context for AI resolution
            </td>
          </tr>
        </tbody>
      </table>
  ...
  "data": {
    ...
    ...
      ...
      <CodeBlock code={`GET /api/worlds/:id`} language="http" />
      ...
      <CodeBlock code={`PUT /api/worlds/:id`} language="http" />
      ...
      <CodeBlock code={`DELETE /api/worlds/:id`} language="http" />
  ...
  "message": "World deleted successfully"
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        <li>
          <Link
            href="/docs/api-reference/entity-schemas"
