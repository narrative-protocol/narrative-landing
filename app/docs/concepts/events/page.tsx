...
export default function EventPage() {
  return (
    <article className="prose prose-invert max-w-none">
      ...
      <p className="text-muted-foreground">
        An <strong>Event</strong> in Narrative Protocol defines something that
        can happen in your world. Events are the actions, triggers, or
        occurrences that drive state changes in your simulation.
      </p>
      ...
      <p className="text-muted-foreground">
        Events describe behavior, not data. They answer the question: &quot;What
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        <li>
          ...
          - A horse race is completed
        </li>
        <li>
          <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
            training_session
          </code>{" "}
          - A horse undergoes training
        </li>
        <li>
          <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
            injury_occurred
      ...
      <table className="w-full border-collapse border border-border my-4">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td className="px-4 py-2 text-muted-foreground">
              One or more versioned implementations
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <CodeBlock code={`POST /api/events`} language="http" />
  ...
  "firstVersion": {
    ...
    "behaviorPrompt": "Determine the race winner based on horse stats."
      ...
      <p className="text-muted-foreground">
        Events have versions that become immutable once published. This ensures
        reproducibility and auditability of state changes over time.
      </p>
      ...
      <p className="text-muted-foreground">
        Without versioning, changing an event would make historical executions
...
Version 2 (published) ─── immutable, can be bound`}
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        <li>
          ...
          - What data the event accepts
        </li>
        <li>
          <code className="bg-muted px-1.5 py-0.5 rounded text-sm">reads</code>{" "}
          - Which entity schemas to read
        </li>
        <li>
          <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
            stateChangeSchema
          </code>{" "}
          - How state changes (partial/full/append)
        </li>
        <li>
          <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
            resultSchema
          </code>{" "}
          - What gets returned publicly
        </li>
        <li>
          <code className="bg-muted px-1.5 py-0.5 rounded text-sm">
            behaviorPrompt
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        <li>
          Version becomes <strong>immutable</strong>
        </li>
      ...
      <Callout type="warning" title="Irreversible Action">
        <p className="text-muted-foreground">
          Publishing a version is <strong>permanent</strong>. Once published,
          the version cannot be modified or deleted. Always test drafts
      ...
      <table className="w-full border-collapse border border-border my-4">
        ...
        <tbody>
          <tr className="border-b border-border">
            ...
            <td className="px-4 py-2 text-muted-foreground">
              Expected input fields and types
            </td>
          </tr>
          <tr className="border-b border-border">
            <td className="px-4 py-2 text-muted-foreground">
            ...
            <td className="px-4 py-2 text-muted-foreground">
              Entity schema IDs the AI can read
            </td>
          </tr>
          <tr className="border-b border-border">
            <td className="px-4 py-2 text-muted-foreground">
          ...
          <tr>
            ...
            <td className="px-4 py-2 text-muted-foreground">
              Instructions for AI resolution
            </td>
          </tr>
        </tbody>
      </table>
      ...
      <p className="text-muted-foreground">
        ...
        maps entity schema names to change modes:
      </p>
  ...
  "race_record": "append"
      ...
      <p className="text-muted-foreground">
        Deployments bind to specific versions. Multiple deployments can use
        different versions:
      </p>
      <pre className="bg-muted p-4 rounded-lg overflow-x-auto text-sm text-muted-foreground">
        {`Event: "race_result"
  ...
  "behaviorPrompt": "Consider weather conditions when determining the winner."
      ...
      <Callout type="tip" title="Version Management Tips">
        <ol className="list-decimal pl-6 space-y-2 text-muted-foreground">
          <li>
            <strong>Test drafts thoroughly</strong> before publishing
          </li>
          <li>
            <strong>Document changes</strong> in version descriptions
          </li>
          <li>
            <strong>Use staging deployments</strong> to test new versions
          </li>
          <li>
            <strong>Never rely on modifying published versions</strong> - create
            new ones instead
          </li>
        </ol>
      </Callout>
      ...
      <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
        ...
        <li>
          ...
          - Where events are bound and executed
        </li>
      </ul>
    </article>
  );
