...
```
1. User calls POST /api/worlds/:worldId/deployments/:deploymentId/execute
   │
   ▼
...
After AI returns, the system applies changes based on `entityChangeSettings`:

```json
// entityChangeSettings
