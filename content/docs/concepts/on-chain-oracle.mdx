...
2. **Fetch off-chain data** from API: `GET /api/worlds/:worldId/deployments/:deploymentId/history`
...
const offChainData = await fetch(`/api/worlds/${worldId}/deployments/${id}/history?page=1&limit=10`);
